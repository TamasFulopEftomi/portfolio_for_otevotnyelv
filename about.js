var titleHU = 'Fülöp Tamás Szoftverfejlesztő';
var titleEN = 'Tamas Fulop Software Developer';
...
var swing_project_2HU = '<h4>A szoftver motivációja:</h4><br>'
    ...
    + '- Négy különböző tekercs belső átmérőre gyártás.<br>'
    + '- Csík tömegének meghatározás egység tömegre, különböző szedések alapján.<br>'
    + '- Csíkok tömegének meghatározása össztömegre méretenként.<br>'
    + '- Méretek arányának meghatározása.<br>'
    + '- Csík átmérőjének meghatározása, különböző szedések alapján.<br>'
...
var swing_project_2EN = '<h4>The motivation of the software:</h4><br>'
    ...
    + '- The calculator creates the optimal cutting pattern for the manufacture of one or more coil(s).<br>'
    + '- The pattern is capabale of munufacturing five different strip widths simultaneously.<br>'
    + '- The pattern is capabale of munufacturing four different coil inner diameters.<br>'
    + '- Strip weight determination per unit weight based on different dimensions selected for picking.<br>'
    + '- Determination of the mass of strips in total and  mass per strip size.<br>'
    + '- Determination of the proportion of dimensions.<br>'
    + '- Determination of strip diameter based on different sheet dimensions.<br>'
...
var facebookHU = '<a href="https://www.facebook.com/tamas.fulop.eftomi" target="_blank" title="Látogass meg a Facebook-on."><i class="fab fa-2x fa-facebook trans"></i></a>';
var facebookEN = '<a href="https://www.facebook.com/tamas.fulop.eftomi" target="_blank" title="Visit me on Facebook."><i class="fab fa-2x fa-facebook trans"></i></a>';
var emailHU = '<a href="mailto:tamas.fulop.eftomi@gmail.com" target="blank" title="Küldj email-t: tamas.fulop.eftomi@gmail.com"><i class="far fa-2x fa-envelope trans"></i></a>';
var emailEN = '<a href="mailto:tamas.fulop.eftomi@gmail.com" target="blank" title="Send me email: tamas.fulop.eftomi@gmail.com"><i class="far fa-2x fa-envelope trans"></i></a>';
var mobileHU = '<a href="tel:+36302512561" target="blank" title="Hívj fel: +36 30 251 2561"><i class="fas fa-2x fa-mobile-alt trans"></i></a>';
var mobileEN = '<a href="tel:+36302512561" target="blank" title="Call me on: +36 30 251 2561"><i class="fas fa-2x fa-mobile-alt trans"></i></a>';

function languageChangeHU() {
    document.getElementById('tx_title').innerHTML = titleHU;
    document.getElementById('tx_name').innerHTML = nameHU;
    document.getElementById('tx_profession').innerHTML = professionHU;

    document.getElementById('btn_about').innerHTML = aboutHU;
    document.getElementById('h_about').innerHTML = aboutHU;
    document.getElementById('btn_faq').innerHTML = faqHU;
    ...
    document.getElementById('about_me').innerHTML = about_meHU;

    document.getElementById('tx_q1').innerHTML = q1HU;
    document.getElementById('tx_a1').innerHTML = a1HU;
    document.getElementById('tx_q2').innerHTML = q2HU;
    document.getElementById('tx_a2').innerHTML = a2HU;
    document.getElementById('tx_q3').innerHTML = q3HU;
    document.getElementById('tx_a3').innerHTML = a3HU;
    document.getElementById('tx_q4').innerHTML = q4HU;
    document.getElementById('tx_a4').innerHTML = a4HU;
    document.getElementById('tx_q5').innerHTML = q5HU;
    document.getElementById('tx_a5').innerHTML = a5HU;

    document.getElementById('techno_development').innerHTML = techno_developmentHU;
    ...
    document.getElementById('i_github').innerHTML = githubHU;
    document.getElementById('i_linkedin').innerHTML = linkedinHU;
    document.getElementById('i_facebook').innerHTML = facebookHU;
    document.getElementById('i_email').innerHTML = emailHU;
    document.getElementById('i_mobile').innerHTML = mobileHU;
}

function languageChangeEN() {
    document.getElementById('tx_title').innerHTML = titleEN;
    document.getElementById('tx_name').innerHTML = nameEN;
    document.getElementById('tx_profession').innerHTML = professionEN;

    document.getElementById('btn_about').innerHTML = aboutEN;
    document.getElementById('h_about').innerHTML = aboutEN;
    document.getElementById('btn_faq').innerHTML = faqEN;
    ...
    document.getElementById('about_me').innerHTML = about_meEN;

    document.getElementById('tx_q1').innerHTML = q1EN;
    document.getElementById('tx_a1').innerHTML = a1EN;
    document.getElementById('tx_q2').innerHTML = q2EN;
    document.getElementById('tx_a2').innerHTML = a2EN;
    document.getElementById('tx_q3').innerHTML = q3EN;
    document.getElementById('tx_a3').innerHTML = a3EN;
    document.getElementById('tx_q4').innerHTML = q4EN;
    document.getElementById('tx_a4').innerHTML = a4EN;
    document.getElementById('tx_q5').innerHTML = q5EN;
    document.getElementById('tx_a5').innerHTML = a5EN;

    document.getElementById('techno_development').innerHTML = techno_developmentEN;
    ...
    document.getElementById('i_github').innerHTML = githubEN;
    document.getElementById('i_linkedin').innerHTML = linkedinEN;
